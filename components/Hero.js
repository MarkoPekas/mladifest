      ...
      <div class="w-full lg:max-w-lg lg:w-1/2 rounded-xl">
        <div>
          <div class="relative w-full max-w-lg">
            ...
            <div class="relative">
              <img class="object-cover object-center mx-auto rounded-lg shadow-2xl" alt="hero" src="/hero.jpg" />
            </div>
          </div>
        </div>
      </div>
      <div class="flex flex-col items-start mt-12 text-left lg:flex-grow lg:w-1/2 lg:pl-6 xl:pl-24 md:mb-0 xl:mt-0">
        <span class="mb-8 text-xs font-bold tracking-widest text-blue-600 uppercase"> Međugorje </span>
        <h1 class="mb-8 text-4xl font-bold leading-none tracking-tighter text-neutral-600 md:text-7xl lg:text-5xl">Međunarodni festival mladih <span className="text-blue-500">"Mladifest"</span></h1>
        <p class="mb-8 text-base leading-relaxed text-left text-gray-500">Međunarodni susret mladih u Međugorju je svake godine od 31.7. do 6.8. Više od 50.000 mladih i 400 svečenika s cijelog svijeta.</p>
        <div class="flex flex-wrap w-full mt-2 -mx-4 text-left">
          ...
          <div class="w-1/4 p-4 mt-4 sm:w-1/4">
            ...
            <img src="https://radio-medjugorje.com/wp-content/uploads/2020/04/mir-logo-96.png" height={44} />
          </div>
          {/* <div class="w-1/4 p-4 mt-4 sm:w-1/4">
            <svg width="42" height="42" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
